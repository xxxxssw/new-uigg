local repo = "https://raw.githubusercontent.com/xxxxssw/new-uigg/refs/heads/main/UniversalUILib/Library.lua"
...
Library:SetWatermark("UniversalUILib demo")
